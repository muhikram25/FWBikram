...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/cssassets/?family=Nunito+Sans:200,300,400,600,700,800,900&display=swap" rel="stylesheet">

    <link rel="stylesheet" href="assets/https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/cssassets//font-awesome.min.cssassets/">
    ...
    <section class="ftco-section ftco-no-pt">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
    		...
    		<div class="row">
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(assets/images/place-1.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(assets/images/place-2.jpg);">
							<div class="desc">
    			...
    			<div class="col-md-4">
    				<a href="#" class="search-place img" style="background-image: url(assets/images/place-3.jpg);">
							<div class="desc">
          ...
          <div class="col-md-12 text-center heading-section heading-section-white ftco-animate">
            ...
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
              	...
              	<img src="assets/images/blob.svg" alt="">
              	</div>
          ...
          <div class="col-md-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services services-2">
              <div class="media-body py-md-4 text-center">
              	...
              	<img src="assets/images/blob.svg" alt=""></div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-7 order-md-last d-flex align-items-stretch">
						<div class="img w-100 img-2 mr-md-2" style="background-image: url(assets/images/about.jpg);"></div>
						<div class="img w-100 img-2 ml-md-2" style="background-image: url(assets/images/about-2.jpg);"></div>
					</div>
